...
# the names below reflect the names of files in which data is stored
PREFIX = "digit_"
TEST_STEM = "test_"
TRAIN_STEM = "train_"

# function to extract zipfile
# input parameters: name of the file; address of directory
...
# this function is called inside next function to load all data
